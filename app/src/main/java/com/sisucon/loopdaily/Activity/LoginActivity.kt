...
import com.sisucon.loopdaily.Adapter.LoginAndFragmentAdapter
import com.sisucon.loopdaily.R
import com.sisucon.loopdaily.lib.ViewPagerUtil
...
class LoginActivity : AppCompatActivity(){
   ...
   @BindView(R.id.login_text) lateinit var loginText : TextView
    ...
    private fun clickText(textView: TextView, isClick:Boolean){
